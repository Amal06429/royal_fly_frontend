...
const EditEnquiryForm = ({ enquiry, onClose, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await api.put(`enquiries/${enquiry.id}/`, formData);
      ...
      <div style={styles.overlay} onClick={onClose}>
        <div style={styles.modal} onClick={(e) => e.stopPropagation()}>
          ...
          <h2 style={styles.title}>
            ✏️ Edit Enquiry
            <span style={styles.adminBadge}>EDIT</span>
          </h2>
          ...
          <form style={styles.form} onSubmit={handleSubmit}>
            ...
            <div style={styles.formGroup}>
              ...
              <textarea
                ...
                onChange={handleChange}
                placeholder="Customer's preferences or special requirements..."
